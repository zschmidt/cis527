...
\begin{description*}
  ...
  Assume propositions $p,q$ with $n,m$ connectives resp., both of which have the property above. $s(p) \leq 2n+1$ and $s(q) \leq 2m+1$. Consider the proposition $r = (p \Box q)$. $r$ must have $n+m+1$ connectives. From the definition of s,
  \begin{align*}
